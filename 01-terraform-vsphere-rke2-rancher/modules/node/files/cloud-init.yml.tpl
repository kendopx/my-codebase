...
- path: /root/.ssh/authorized_keys
  content: |
    ssh-rsa AAAAB000000j8H8j/18TW7dfD5\2
...
runcmd:
  ...
  - KUBECONFIG=/etc/rancher/rke2/rke2-rancher.yaml /var/lib/rancher/rke2/bin/kubectl config set-cluster default --server https://${public_address}:6443
  - KUBECONFIG=/etc/rancher/rke2/rke2-rancher.yaml/var/lib/rancher/rke2/bin/kubectl config rename-context default ${cluster_name}  
  - /bin/cp -rf /var/lib/rancher/rke2/bin/kubectl /usr/local/bin  
  - systemctl disable firewalld.service
  - systemctl stop firewalld.service  
